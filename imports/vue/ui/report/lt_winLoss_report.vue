    ...
    <div class="winLoss-report">
        <a4>
            ...
            <v-row type="flex" class="row-bg" justify="center">
                ...
                <v-col cols="12" md="12" sm="12" style="text-align: center !important;">
                        <span style="font-family: 'Khmer OS Muol'; font-size: 15px;">{{$t('winLossTitle')}} -{{agentName}}</span><br>
                        <span style="font-family: 'Khmer OS Muol'; font-size: 15px;">ប្រចាំថ្ងៃទី៖ {{formatDate(params.date)}}</span>
                </v-col>
          ...
          printReport() {
            ...
            handleRun() {
                ...
                if (this.$refs.formReport.validate()) {
                    Meteor.call('base_fetchWinLossReport', vm.params, Constants.secret, vm.$i18n.locale, (err, result) => {
                        if (result) {
